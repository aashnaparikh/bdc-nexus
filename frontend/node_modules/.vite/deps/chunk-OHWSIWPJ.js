...
var invisibleText;
var getBundle = () => {
  i18nBundle ?? (i18nBundle = new i18nBundle_default("@ui5/webcomponents-base"));
  return i18nBundle;
};
...
var ListItemCustom = ListItemCustom_1 = class ListItemCustom2 extends ListItem_default {
  ...
  _getDeleteButtonNodes() {
    ...
    const deleteButton = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector(`#${this._id}-deleteSelectionElement`);
  ...
  get accessibilityInfo() {
    var _a;
    const children = [];
    const defaultSlot = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector("slot:not([name])");
    if (defaultSlot) {
...
//# sourceMappingURL=chunk-OHWSIWPJ.js.map
