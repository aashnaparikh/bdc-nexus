...
var setDraggedElement = (element, e) => {
  ...
  (_a = e == null ? void 0 : e.dataTransfer) == null ? void 0 : _a.setData("text/plain", element ? element.id : "");
};
...
var DragAndDropHandler = class {
  ...
  ondragleave(e) {
    var _a;
    if (e.relatedTarget instanceof Node && ((_a = this.component.shadowRoot) == null ? void 0 : _a.contains(e.relatedTarget))) {
      return;
    }
  ...
  ondrop(e) {
    const dropIndicator = this.config.getDropIndicator();
    if (!(dropIndicator == null ? void 0 : dropIndicator.targetReference) || !(dropIndicator == null ? void 0 : dropIndicator.placement)) {
      e.preventDefault();
      return;
    }
    const settings = this.config.useOriginalEvent ? { originalEvent: true } : {};
...
function renderTitle() {
  ...
  if (this.wrappingType === WrappingType_default.Normal) {
    return (_a = this.expandableTextTemplate) == null ? void 0 : _a.call(this, {
  ...
  onBeforeRendering() {
    ...
    if (this.wrappingType === "Normal") {
      if (ListItemGroupHeader_1.ExpandableTextTemplate) {
        ...
        import("./ListItemStandardExpandableTextTemplate-QV6Z7ABE.js").then((module) => {
...
var List = List_1 = class List2 extends UI5Element_default {
  ...
  get growingButtonAriaLabel() {
    var _a;
    return (_a = this.accessibilityAttributes.growingButton) == null ? void 0 : _a.name;
  }
  get growingButtonAriaLabelledBy() {
    var _a;
    return ((_a = this.accessibilityAttributes.growingButton) == null ? void 0 : _a.name) ? void 0 : `${this._id}-growingButton-text`;
  }
  get growingButtonAriaDescribedBy() {
    var _a;
    return ((_a = this.accessibilityAttributes.growingButton) == null ? void 0 : _a.description) ? `${this._id}-growingButton-description` : void 0;
  }
  hasGrowingComponent() {
    if (this.growsOnScroll) {
  ...
  */
  ...
  _onkeydown(e) {
    ...
    if ((listItem == null ? void 0 : listItem._isFocusOnInternalElement()) && isArrowKey) {
  ...
  */
  ...
  _navigateToAdjacentItem(listItem, offset) {
    const targetInternalElementIndex = listItem == null ? void 0 : listItem._getFocusedElementIndex();
  ...
  onItemToggle(e) {
    var _a;
    if (!((_a = e.target) == null ? void 0 : _a.isListItemBase)) {
      return;
    }
...
//# sourceMappingURL=chunk-RN7W6YLZ.js.map
