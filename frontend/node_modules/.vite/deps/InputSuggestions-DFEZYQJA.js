...
} from "./chunk-SB53L4ZR.js";
import {
  Input_default
} from "./chunk-EY6KEHCA.js";
import {
...
var Suggestions = class _Suggestions {
  ...
  isOpened() {
    var _a;
    return !!((_a = this._getPicker()) == null ? void 0 : _a.open);
  }
  ...
  _moveItemSelection(previousIdx, nextIdx) {
    ...
    const nonGroupItems = this._getNonGroupItems();
    const isGroupItem = currentItem == null ? void 0 : currentItem.hasAttribute("ui5-suggestion-item-group");
    if (!currentItem) {
      return;
    }
    ...
    if ((previousItem == null ? void 0 : previousItem.hasAttribute("ui5-suggestion-item")) || (previousItem == null ? void 0 : previousItem.hasAttribute("ui5-suggestion-item-custom"))) {
  ...
  _getListWidth() {
    var _a;
    return (_a = this._getList()) == null ? void 0 : _a.offsetWidth;
  }
  _getPicker() {
...
//# sourceMappingURL=InputSuggestions-DFEZYQJA.js.map
