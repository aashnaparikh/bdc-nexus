...
var setFormValue = (element) => {
  var _a, _b;
  if (!((_a = element._internals) == null ? void 0 : _a.form)) {
    return;
  }
  setFormValidity(element);
  if (!element.name) {
    (_b = element._internals) == null ? void 0 : _b.setFormValue(null);
    return;
  }
...
var setFormValidity = async (element) => {
  var _a, _b;
  if (!element.isUI5Element || !((_a = element._internals) == null ? void 0 : _a.form)) {
    return;
  }
  ...
  if (element.formValidity && Object.keys(element.formValidity).some((key) => key)) {
    const focusRef = await ((_b = element.formElementAnchor) == null ? void 0 : _b.call(element));
...
var submitForm = async (element) => {
  var _a, _b, _c, _d;
  const elements = [...((_b = (_a = element._internals) == null ? void 0 : _a.form) == null ? void 0 : _b.elements) ?? []];
  await Promise.all(elements.map((el) => {
    return isInputElement(el) ? setFormValidity(el) : Promise.resolve();
  }));
  (_d = (_c = element._internals) == null ? void 0 : _c.form) == null ? void 0 : _d.requestSubmit();
};
var resetForm = (element) => {
  var _a, _b;
  (_b = (_a = element._internals) == null ? void 0 : _a.form) == null ? void 0 : _b.reset();
};
...
var I18nBundle = class {
  constructor(packageName13) {
    this.packageName = packageName13;
  }
  /**
...
var getI18nBundleSync = (packageName13) => {
  if (I18nBundleInstances.has(packageName13)) {
    return I18nBundleInstances.get(packageName13);
  }
  const i18nBundle = new I18nBundle(packageName13);
  I18nBundleInstances.set(packageName13, i18nBundle);
  return i18nBundle;
};
var getI18nBundle = async (packageName13) => {
  if (customGetI18nBundle) {
    return customGetI18nBundle(packageName13);
  }
  await fetchI18nBundle(packageName13);
  return getI18nBundleSync(packageName13);
};
...
var UI5Element = class _UI5Element extends HTMLElement {
  ...
  _onShadowRootSlotChange(e2) {
    var _a;
    const targetShadowRoot = (_a = e2.target) == null ? void 0 : _a.getRootNode();
...
var jsxRenderer = (instance, container) => {
  ...
  if (instance.__shouldHydrate) {
    (_a = instance.shadowRoot) == null ? void 0 : _a.querySelectorAll("style").forEach((style) => style.remove());
    E(vnode, container);
...
var registerIcon = (name13, iconData) => {
  const key = `${iconData.collection}/${name13}`;
  const data = {
...
var processName = (name13) => {
  if (name13.startsWith("sap-icon://")) {
    name13 = name13.replace("sap-icon://", "");
  }
  let collection13;
  [name13, collection13] = name13.split("/").reverse();
  name13 = name13.replace("icon-", "");
  if (collection13) {
    collection13 = getIconCollectionByAlias(collection13);
  }
  return { name: name13, collection: collection13 };
};
var getIconDataSync = (iconName) => {
  const { name: name13, collection: collection13 } = processName(iconName);
  return getRegisteredIconData(collection13, name13);
};
var getIconData = async (iconName) => {
  const { name: name13, collection: collection13 } = processName(iconName);
  let iconData = ICON_NOT_FOUND;
  try {
    iconData = await _loadIconCollectionOnce(getIconCollectionByTheme_default(collection13));
  } catch (error) {
    const e2 = error;
  ...
  const registeredIconData = getRegisteredIconData(collection13, name13);
  ...
  if (Array.isArray(iconData)) {
    iconData.forEach((data) => {
      _fillRegistry(data);
      registerIconCollectionForTheme(collection13, { [data.themeFamily || DEFAULT_THEME_FAMILY]: data.collection });
    });
  } else {
...
var getRegisteredIconData = (collection13, name13) => {
  const registryKey = `${getIconCollectionByTheme_default(collection13)}/${name13}`;
  return registry.get(registryKey);
};
var getIconAccessibleName = async (name13) => {
  var _a;
  if (!name13) {
    return;
  }
  ...
  if (iconData && iconData !== ICON_NOT_FOUND && iconData.accData) {
    ...
    return ((_a = iconData.accData) == null ? void 0 : _a.defaultText) || "";
  }
};
  ...
  async onBeforeRendering() {
    ...
    if (this.accessibleName) {
      ...
      if (this.packageName) {
        ...
        this.effectiveAccessibleName = ((_a = this.accData) == null ? void 0 : _a.defaultText) || void 0;
      }
    } else {
...
function registerPopupWithOpenUI5Support(popupInfo) {
  openUI5Support == null ? void 0 : openUI5Support.addOpenedPopup(popupInfo);
}
function unregisterPopupWithOpenUI5Support(popup) {
  openUI5Support == null ? void 0 : openUI5Support.removeOpenedPopup(popup);
}
...
var Popup = Popup_1 = class Popup2 extends UI5Element_default {
  ...
  resetFocus() {
    var _a;
    (_a = this._focusedElementBeforeOpen) == null ? void 0 : _a.focus();
...
var Popover = Popover_1 = class Popover2 extends Popup_default {
  ...
  getPopoverSize(calcScrollHeight = false) {
    ...
    if (calcScrollHeight && domRef) {
      ...
      height = (content2 == null ? void 0 : content2.scrollHeight) || 0;
      height += (header == null ? void 0 : header.scrollHeight) || 0;
      height += (footer == null ? void 0 : footer.scrollHeight) || 0;
    } else {
      height = rect.height;
    }
    return { width, height };
  ...
  focusOpener() {
    var _a;
    (_a = this.getOpenerHTMLElement(this.opener)) == null ? void 0 : _a.focus();
  }
  /**
   * @private
   */
...
//# sourceMappingURL=chunk-4A2KCNZA.js.map
