...
var SliderTooltip = SliderTooltip_1 = class SliderTooltip2 extends UI5Element_default {
  ...
  repositionTooltip() {
    var _a;
    const followRefRect = (_a = this.followRef) == null ? void 0 : _a.getBoundingClientRect();
    if (!followRefRect) {
      return;
    }
  ...
  _onInputInput() {
    var _a;
    this.fireDecoratorEvent("input", { value: (_a = this.inputRef) == null ? void 0 : _a.value });
  }
  _onInputFocusOut(e) {
    var _a;
    const relatedTarget = e.relatedTarget;
    if (!((_a = this.parentElement) == null ? void 0 : _a.contains(relatedTarget))) {
      this.hidePopover();
    }
    this.fireDecoratorEvent("change", { value: e.target.value });
  ...
  get inputRef() {
    var _a;
    return (_a = this.shadowRoot) == null ? void 0 : _a.querySelector("[ui5-input]");
  }
};
__decorate2([
  property_default()
...
var Slider = Slider_1 = class Slider2 extends SliderBase_default {
  ...
  onAfterRendering() {
    ...
    (_a = this.tooltip) == null ? void 0 : _a.repositionTooltip();
  }
  _handleResize() {
  }
  /**
  ...
  _onfocusout(e) {
    ...
    if (this.showTooltip && !((_a = e.relatedTarget) == null ? void 0 : _a.hasAttribute("ui5-slider-tooltip"))) {
      this._tooltipsOpen = false;
    }
  }
  _onTooltipChange(e) {
  ...
  _onTooltopForwardFocus(e) {
    ...
    (_a = tooltip2.followRef) == null ? void 0 : _a.focus();
  }
  get inputValue() {
    return this.value.toString();
  }
  get tooltip() {
    var _a;
    return (_a = this.getDomRef()) == null ? void 0 : _a.querySelector("[ui5-slider-tooltip]");
  }
  get _sliderHandle() {
...
//# sourceMappingURL=chunk-BPSIRB5M.js.map
