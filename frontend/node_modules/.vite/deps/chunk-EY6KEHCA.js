...
function InputPopoverTemplate(hooks) {
  ...
  const mobileHeader = hooks == null ? void 0 : hooks.mobileHeader;
  return jsxs(Fragment, { children: [this._effectiveShowSuggestions && ((_a = this.Suggestions) == null ? void 0 : _a.template.call(this, {
    suggestionsList,
    mobileHeader,
    valueStateMessage,
...
var Input = Input_1 = class Input2 extends UI5Element_default {
  get formValidityMessage() {
    var _a;
    return (_a = this.nativeInput) == null ? void 0 : _a.validationMessage;
  }
  ...
  get formValidity() {
    var _a, _b, _c;
    return {
      valueMissing: (_a = this.nativeInput) == null ? void 0 : _a.validity.valueMissing,
      typeMismatch: this.required && ((_b = this.nativeInput) == null ? void 0 : _b.validity.typeMismatch),
      patternMismatch: (_c = this.nativeInput) == null ? void 0 : _c.validity.patternMismatch
    };
  }
  ...
  onExitDOM() {
    ...
    (_a = this._composition) == null ? void 0 : _a.removeEventListeners();
  }
  _highlightSuggestionItem(item) {
    var _a;
    item.markupText = this.typedInValue ? (_a = this.Suggestions) == null ? void 0 : _a.hightlightInput(item.text || "", this.typedInValue) : encodeXML_default(item.text || "");
  }
  _isGroupItem(item) {
    ...
    if (this.showSuggestions) {
      ...
      this._flattenItems.forEach((item) => {
        ...
        if (item.hasAttribute("ui5-suggestion-item")) {
          ...
          (_a = item.items) == null ? void 0 : _a.forEach((nestedItem) => {
  ...
  onAfterRendering() {
    var _a;
    const innerInput = this.getInputDOMRefSync();
    if (this.showSuggestions && ((_a = this.Suggestions) == null ? void 0 : _a._getPicker())) {
  ...
  _adjustContainsSelectionRange() {
    var _a, _b;
    const innerInput = this.getInputDOMRefSync();
    const visibleItems = (_a = this.Suggestions) == null ? void 0 : _a._getItems().filter((item) => !item.hidden);
    const currentItem = visibleItems == null ? void 0 : visibleItems.find((item) => {
    ...
    if (currentItem && !groupItems.includes(currentItem)) {
      const doesItemStartWithTypedValue = (_b = currentItem == null ? void 0 : currentItem.text) == null ? void 0 : _b.toLowerCase().startsWith(this.typedInValue.toLowerCase());
  ...
  get currentItemIndex() {
    var _a;
    const allItems = (_a = this.Suggestions) == null ? void 0 : _a._getItems();
  ...
  _handleUp(e) {
    var _a;
    if ((_a = this.Suggestions) == null ? void 0 : _a.isOpened()) {
      ...
      this._linksListenersArray.push((e) => {
        attachListeners(e, links, index, {
          closeValueState: () => {
            var _a, _b;
            if ((_a = this.Suggestions) == null ? void 0 : _a.isOpened()) {
              (_b = this.Suggestions) == null ? void 0 : _b.close();
            }
          ...
          isPopoverOpen: () => {
            var _a;
            return this.Suggestions && ((_a = this.Suggestions) == null ? void 0 : _a.isOpened()) || false;
          }
        });
      });
  ...
  _handleEnter(e) {
    var _a;
    const suggestionItemPressed = !!((_a = this.Suggestions) == null ? void 0 : _a.onEnter(e));
    const innerInput = this.getInputDOMRefSync();
  ...
  _handlePageUp(e) {
    ...
    if (this._isSuggestionsFocused) {
      (_a = this.Suggestions) == null ? void 0 : _a.onPageUp(e);
    } else {
      e.preventDefault();
    }
  }
  _handlePageDown(e) {
    var _a;
    if (this._isSuggestionsFocused) {
      (_a = this.Suggestions) == null ? void 0 : _a.onPageDown(e);
    } else {
      e.preventDefault();
    }
  }
  _handleHome(e) {
    var _a;
    if (this._isSuggestionsFocused) {
      (_a = this.Suggestions) == null ? void 0 : _a.onHome(e);
    }
  }
  _handleEnd(e) {
    var _a;
    if (this._isSuggestionsFocused) {
      (_a = this.Suggestions) == null ? void 0 : _a.onEnd(e);
    }
  }
  _handleEscape() {
    var _a;
    ...
    if (isOpen && ((_a = this.Suggestions) == null ? void 0 : _a._isItemOnTarget())) {
  ...
  _onfocusout(e) {
    ...
    if (((_b = (_a = this.Suggestions) == null ? void 0 : _a._getPicker()) == null ? void 0 : _b.contains(toBeFocused)) || this.contains(toBeFocused) || this.getSlottedNodes("valueStateMessage").some((el) => el.contains(toBeFocused))) {
      return;
    }
    this.focused = false;
    this._isChangeTriggeredBySuggestion = false;
  ...
  _clearPopoverFocusAndSelection() {
    ...
    this.hasSuggestionItemSelected = false;
    (_a = this.Suggestions) == null ? void 0 : _a._deselectItems();
    (_b = this.Suggestions) == null ? void 0 : _b._clearItemFocus();
  }
  _click() {
  ...
  _handleChange() {
    ...
    if (this.previousValue !== this.getInputDOMRefSync().value) {
      if (((_b = (_a = this.Suggestions) == null ? void 0 : _a._getPicker()) == null ? void 0 : _b.open) && this._flattenItems.some((item) => item.hasAttribute("ui5-suggestion-item") && item.selected)) {
  ...
  _handleSelectionChange(e) {
    var _a;
    (_a = this.Suggestions) == null ? void 0 : _a.onItemPress(e);
  }
  ...
  _resetItemVisibility() {
    this._flattenItems.forEach((item) => {
      ...
      if (this._isGroupItem(item)) {
        (_a = item.items) == null ? void 0 : _a.forEach((i) => {
          i.hidden = false;
        });
        return;
      }
  ...
  _afterOpenPicker() {
    ...
    if (isPhone()) {
      this.previousValue = this.value;
      this.getInputDOMRef().focus();
      (_a = this._composition) == null ? void 0 : _a.addEventListeners();
    }
  ...
  _handlePickerAfterClose() {
    var _a;
    (_a = this.Suggestions) == null ? void 0 : _a._onClose();
  ...
  enableSuggestions() {
    ...
    if (Input_1.SuggestionsClass) {
      ...
      import("./InputSuggestions-DFEZYQJA.js").then((SuggestionsModule) => {
  ...
  _enableComposition() {
    ...
    if (Input_1.composition) {
      ...
      import("./InputComposition-BECLPNK5.js").then((CompositionModule) => {
  ...
  isSuggestionsScrollable() {
    ...
    return (_a = this.Suggestions) == null ? void 0 : _a._isScrollable();
  }
  onItemMouseDown(e) {
    e.preventDefault();
  }
  ...
  get availableSuggestionsCount() {
    var _a;
    if (this.showSuggestions && (this.value || ((_a = this.Suggestions) == null ? void 0 : _a.isOpened()))) {
  ...
  get _isSuggestionsFocused() {
    var _a;
    return !this.focused && ((_a = this.Suggestions) == null ? void 0 : _a.isOpened());
  }
  /**
...
@ui5/webcomponents-base/dist/sap/base/security/encodeXML.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EY6KEHCA.js.map
