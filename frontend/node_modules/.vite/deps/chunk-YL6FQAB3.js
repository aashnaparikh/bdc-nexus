...
} from "./chunk-OHWSIWPJ.js";
import {
  List_default
} from "./chunk-RN7W6YLZ.js";
import {
  ResponsivePopover_default
} from "./chunk-FYL4BIZ6.js";
import {
...
function SplitButtonTemplate() {
  ...
  return jsxs("div", { role: this._hideArrowButton ? "presentation" : "group", class: "ui5-split-button-root", tabindex: this._tabIndex, "aria-labelledby": !this._hideArrowButton ? `${this._id}-invisibleTextDefault ${this._id}-invisibleText` : void 0, "aria-haspopup": (_b = (_a = this._computedAccessibilityAttributes) == null ? void 0 : _a.root) == null ? void 0 : _b.hasPopup, "aria-roledescription": (_d = (_c = this._computedAccessibilityAttributes) == null ? void 0 : _c.root) == null ? void 0 : _d.roleDescription, "aria-label": (_f = (_e = this._computedAccessibilityAttributes) == null ? void 0 : _e.root) == null ? void 0 : _f.title, "aria-keyshortcuts": (_h = (_g = this._computedAccessibilityAttributes) == null ? void 0 : _g.root) == null ? void 0 : _h.ariaKeyShortcuts, onFocusOut: this._onFocusOut, onKeyDown: this._onKeyDown, onKeyUp: this._onKeyUp, children: [jsx(Button_default, { class: "ui5-split-text-button", design: this.design, icon: this.icon, endIcon: this._endIcon, tabindex: -1, disabled: this.disabled, active: this._textButtonActive, exportparts: "icon,endIcon,button", onClick: this._handleMouseClick, onTouchStart: this.handleTouchStart, onMouseDown: this.handleTouchStart, onMouseUp: this._textButtonRelease, onFocusIn: this._onInnerButtonFocusIn, onFocusOut: this._onFocusOut, tooltip: (_j = (_i = this._computedAccessibilityAttributes) == null ? void 0 : _i.root) == null ? void 0 : _j.title, children: this.isTextButton && jsx("slot", {}) }), !this._hideArrowButton && jsxs(Fragment, { children: [jsx(Button_default, { class: "ui5-split-arrow-button", design: this.design, icon: slim_arrow_down_default, tabindex: -1, tooltip: (_l = (_k = this._computedAccessibilityAttributes) == null ? void 0 : _k.arrowButton) == null ? void 0 : _l.title, accessibilityAttributes: { hasPopup: (_n = (_m = this._computedAccessibilityAttributes) == null ? void 0 : _m.arrowButton) == null ? void 0 : _n.hasPopup, expanded: (_p = (_o = this._computedAccessibilityAttributes) == null ? void 0 : _o.arrowButton) == null ? void 0 : _p.expanded }, disabled: this.disabled, active: this.effectiveActiveArrowButton, part: "arrowButton", onClick: this._handleArrowButtonAction, onMouseDown: this._arrowButtonPress, onMouseUp: this._arrowButtonRelease, onFocusIn: this._onInnerButtonFocusIn, onActiveStateChange: this._onArrowButtonActiveStateChange }), jsxs("span", { id: `${this._id}-invisibleText`, class: "ui5-hidden-text", children: [this.accInfo.keyboardHint, " ", this.accessibleName] }), jsx("span", { id: `${this._id}-invisibleTextDefault`, class: "ui5-hidden-text", children: this.buttonTextContent })] })] });
}
...
var SplitButton = SplitButton_1 = class SplitButton2 extends UI5Element_default {
  ...
  get _computedAccessibilityAttributes() {
    ...
    return {
      root: {
        hasPopup: (_b = (_a = this.accessibilityAttributes) == null ? void 0 : _a.root) == null ? void 0 : _b.hasPopup,
        roleDescription: ((_d = (_c = this.accessibilityAttributes) == null ? void 0 : _c.root) == null ? void 0 : _d.roleDescription) || (this._hideArrowButton ? void 0 : SplitButton_1.i18nBundle.getText(SPLIT_BUTTON_DESCRIPTION)),
        title: (_f = (_e = this.accessibilityAttributes) == null ? void 0 : _e.root) == null ? void 0 : _f.title,
        ariaKeyShortcuts: (_h = (_g = this.accessibilityAttributes) == null ? void 0 : _g.root) == null ? void 0 : _h.ariaKeyShortcuts
      },
      arrowButton: {
        hasPopup: ((_j = (_i = this.accessibilityAttributes) == null ? void 0 : _i.arrowButton) == null ? void 0 : _j.hasPopup) || "menu",
        expanded: ((_l = (_k = this.accessibilityAttributes) == null ? void 0 : _k.arrowButton) == null ? void 0 : _l.expanded) || this.effectiveActiveArrowButton,
        title: ((_n = (_m = this.accessibilityAttributes) == null ? void 0 : _m.arrowButton) == null ? void 0 : _n.title) || this.arrowButtonTooltip
      }
    };
  }
  get accInfo() {
...
var Menu = Menu_1 = class Menu2 extends UI5Element_default {
  ...
  getFocusDomRef() {
    var _a;
    return (_a = this._list) == null ? void 0 : _a.getFocusDomRef();
  }
  ...
  _itemMouseOver(e) {
    ...
    (_a = item.getFocusDomRef()) == null ? void 0 : _a.focus();
  ...
  _navigateOutOfEndContent(e) {
    ...
    if (itemIndex > -1) {
      ...
      itemToFocus == null ? void 0 : itemToFocus.focus();
      e.stopPropagation();
    }
  }
  ...
  _afterPopoverOpen() {
    var _a;
    (_a = this._allMenuItems[0]) == null ? void 0 : _a.focus();
...
//# sourceMappingURL=chunk-YL6FQAB3.js.map
